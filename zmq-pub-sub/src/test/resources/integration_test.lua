...
local address = address or "tcp://*:5562"
local periodicAddress = periodicAddress or "tcp://*:5563"
local connectAddress = connectAddress or "tcp://127.0.0.1:5562"
local periodicConnectAddress = periodicConnectAddress or "tcp://127.0.0.1:5563"
